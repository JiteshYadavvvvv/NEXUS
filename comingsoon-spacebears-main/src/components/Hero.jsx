...
export default function Hero({ entered }) {
  ...
  return (
    <div ref={ghostRef} className="relative w-full h-screen">
      ...
      >
        <div className="absolute inset-0 w-full h-full bg-grid-pattern animate-grid-scroll pointer-events-none opacity-20"></div>
        <div
          ref={heroParallaxRef}
            ...
            >
              <div className="hidden md:block w-full h-full">
                <SplineScene
                  ...
                  style={{ borderRadius: SPLINE_RADIUS, overflow: "hidden" }}
                  onLoad={() => {
              ...
              <div className="block md:hidden w-full h-full">
                <img
                  ...
                  alt="Coming Soon"
                  className="w-full h-full object-contain bg-black rounded-[24px]"
                  onLoad={() => {
                    setSplineLoaded(true);
                    window.dispatchEvent(new CustomEvent("splineLoaded"));
                  }}
