      ...
      >
        ...
        <div className="relative w-full flex-grow px-5 pb-2 z-10 pointer-events-none">
          <div className={cn(
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-zinc-950 via-zinc-900/40 to-transparent opacity-90 group-hover:opacity-30 transition-opacity duration-500 pointer-events-none" />
          </div>
        </div>
